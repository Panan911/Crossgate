...
def user_skill(skill_name,skill_lv):
    ...
    if color == "93bb6c" : # 选中菜单
        print('执行脚本第{}行'.format(sys._getframe().f_lineno),'技能面板已弹出,选择技能')
    elif color == "d4ad6a" :
        print('执行脚本第{}行'.format(sys._getframe().f_lineno),'技能面板未弹出,去点击技能菜单')
...
### 人物强力魔法
summoner_ql_skill = "强力陨石魔法"
summoner_ql_skill_lv = 1
summoner_ql_skill_ndmp = 10
### 人物全体技能设置
summoner_qt_skill = "超强陨石魔法"
